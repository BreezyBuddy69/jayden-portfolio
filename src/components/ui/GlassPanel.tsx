...
export const GlassPanel = forwardRef<HTMLDivElement, GlassPanelProps>(
  ({ children, className = '', glow = false, strong = false, onClick, style, 'data-cursor': dataCursor }, ref) => {
    const base = strong
      ...
      : 'backdrop-blur-xl border border-white/[0.08] hover:border-violet-500/30'
    ...
    const shadow = glow
      ? 'shadow-[inset_0_1px_0_rgba(255,255,255,0.10),0_0_40px_rgba(0,0,0,0.5),0_0_60px_rgba(139, 92, 246,0.12)]'
